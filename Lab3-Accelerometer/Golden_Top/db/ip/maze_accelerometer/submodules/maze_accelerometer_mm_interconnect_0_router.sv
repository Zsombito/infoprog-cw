...
module maze_accelerometer_mm_interconnect_0_router_default_decode
  #(
...
module maze_accelerometer_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD7 = log2ceil(64'h2104a - 64'h21048); 
    // -------------------------------------------------------
    ...
    maze_accelerometer_mm_interconnect_0_router_default_decode the_default_decode(
